...
class _ArrearPageState extends State<ArrearPage> with SingleTickerProviderStateMixin {
...
class EmployeeArrearCard extends StatefulWidget {
  final String biometricId;
  final String name;
  final VoidCallback onTap;

  const EmployeeArrearCard({
  ...
  @override
  State<EmployeeArrearCard> createState() => _EmployeeArrearCardState();
}

class _EmployeeArrearCardState extends State<EmployeeArrearCard> with SingleTickerProviderStateMixin {
